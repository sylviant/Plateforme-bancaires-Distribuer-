    ...
    <div style={{ display: 'block' }}>
      <div style={{ display: 'table', width: '100%', marginBottom: '20px' }}>
        <div style={{ display: 'table-row' }}>
          <button style={{ ...tabStyle, borderBottom: activeTab === 'comptes' ? '3px solid #10b981' : 'none' }} onClick={() => setActiveTab('comptes')}>Mes Comptes Financiers Acceil</button>
          <button style={{ ...tabStyle, borderBottom: activeTab === 'virement' ? '3px solid #10b981' : 'none' }} onClick={() => setActiveTab('virement')}>Faire un Virement Acceil</button>
          <button style={{ ...tabStyle, borderBottom: activeTab === 'prets' ? '3px solid #10b981' : 'none' }} onClick={() => setActiveTab('prets')}>Mes Prêts & Crédits Acceil</button>
          <button style={{ ...tabStyle, borderBottom: activeTab === 'ocr' ? '3px solid #10b981' : 'none' }} onClick={() => setActiveTab('ocr')}>Vérification IA / OCR Acceil</button>
        </div>
      </div>
